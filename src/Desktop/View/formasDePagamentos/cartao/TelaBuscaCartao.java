 ...
 * @author gustavo
 */
public class TelaBuscaCartao extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscaCartao
     */
    public TelaBuscaCartao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTablePersonal.getColumnModel().getColumnCount() > 0) {
            ...
            jTablePersonal.getColumnModel().getColumn(0).setPreferredWidth(15);
    ...
    private static final Logger LOG = Logger.getLogger(TelaBuscaCartao.class.getName());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCartao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaCartao dialog = new TelaBuscaCartao(new javax.swing.JFrame(), true);
