...
public class TelaBuscaServico extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TelaBuscaServico
     */
    ...
    private void initComponents() {
        ...
        jTablePersonal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Cd.Barra", "Nome", "Valor", "UN.Venda", "Personal", "Status"
            }
        ) {
        ...
        if (jTablePersonal.getColumnModel().getColumnCount() > 0) {
            ...
            jTablePersonal.getColumnModel().getColumn(6).setPreferredWidth(25);
        }
    ...
    private static final Logger LOG = Logger.getLogger(TelaBuscaServico.class.getName());
