 ...
 * @author gustavo
 */
public class FormTemplateBusca extends javax.swing.JDialog {

    /**
     * Creates new form FormTemplateBusca
     */
    public FormTemplateBusca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setBackground(new java.awt.Color(13, 13, 13));
        ...
        jTable2.setIntercellSpacing(new java.awt.Dimension(20, 20));
    ...
    private static final Logger LOG = Logger.getLogger(FormTemplateBusca.class.getName());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTemplateBusca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTemplateBusca dialog = new FormTemplateBusca(new javax.swing.JFrame(), true);
