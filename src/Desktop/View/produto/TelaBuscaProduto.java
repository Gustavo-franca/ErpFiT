...
public class TelaBuscaProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableProduto.setBackground(new java.awt.Color(13, 13, 13));
        jTableProduto.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jTableProduto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null}
            },
            new String [] {
                "id", "cd. Barras", "Valor", "Un. Venda", "Estoque", "Un. Compra", "Status"
            }
        ) {
        ...
        jTableProduto.setIntercellSpacing(new java.awt.Dimension(20, 20));
        ...
        if (jTableProduto.getColumnModel().getColumnCount() > 0) {
            ...
            jTableProduto.getColumnModel().getColumn(6).setPreferredWidth(30);
        }
    ...
    private static final Logger LOG = Logger.getLogger(TelaBuscaProduto.class.getName());
