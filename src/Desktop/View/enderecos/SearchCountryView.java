 ...
 * @author gustavo
 */
public class SearchCountryView extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscaPais
     */
    public SearchCountryView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private static final Logger LOG = Logger.getLogger(SearchCountryView.class.getName());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCountryView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchCountryView dialog = new SearchCountryView(new javax.swing.JFrame(), true);
